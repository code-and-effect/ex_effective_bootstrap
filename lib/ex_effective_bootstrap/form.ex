defmodule ExEffectiveBootstrap.Form do
  ...
  @spec effective_form_for(Phoenix.HTML.FormData.t(), String.t(), Keyword.t()) :: Phoenix.HTML.Form.t()
  ...
  @spec effective_form_for(Phoenix.HTML.FormData.t(), String.t(), (Phoenix.HTML.Form.t() -> Phoenix.HTML.unsafe())) :: Phoenix.HTML.safe()
  @spec effective_form_for(Phoenix.HTML.FormData.t(), String.t(), Keyword.t(), (Phoenix.HTML.Form.t()-> Phoenix.HTML.unsafe())) :: Phoenix.HTML.safe()
